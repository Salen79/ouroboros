...
- Per-task hard cap: $3.00. При достижении — пауза, decompose на подзадачи через schedule_task или уточнение у owner.
...
- Per-task cost cap: $3.00. Превышение = auto-pause + decompose.
